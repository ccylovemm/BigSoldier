...
#else
            activeSceneName = EditorApplication.currentScene;
#endif

            if (!string.IsNullOrEmpty(activeSceneName)) {
                levelName = Path.GetFileNameWithoutExtension(activeSceneName);
            }
#endif
        }
...
#if UNITY_5 && !(UNITY_5_0 || UNITY_5_1 || UNITY_5_2)
        Scene activeScene = SceneManager.GetActiveScene();
        return SceneManager.LoadSceneAsync(activeScene.name);
#else
